...
export default function Example() {
  const { signUpWithEmail, signInWithGoogle, authLoading, authError } = useAuth()
    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-50">Create your account now</h2>
        </div>
        <form onSubmit={signUpWithEmail} className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border bg-light-gray border-border-gray placeholder-gray-300 text-white focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 focus:z-10 sm:text-sm"
